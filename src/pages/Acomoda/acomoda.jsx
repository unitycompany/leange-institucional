...
const suites = [
    {
        ...
        features: [
            { icon: <FaPaw />, text: 'Ar condicionado' },
            { icon: <FaPaw />, text: 'Frigobar' },
            { icon: <FaPaw />, text: 'Lareira' },
            { icon: <FaPaw />, text: 'Chaleira elétrica' },
            { icon: <FaPaw />, text: 'Smart TV' },
            { icon: <FaPaw />, text: 'Cama king size' },
            { icon: <FaPaw />, text: 'Banheira relaxante' },
            { icon: <FaPaw />, text: 'Chuveiro' },
            { icon: <FaPaw />, text: 'Aquecedor de toalhas' },
            { icon: <FaPaw />, text: 'Cuba única' },
            { icon: <FaPaw />, text: 'Varanda privativa' },
        ],
        images: [
...

    {
        ...
        features: [
            { icon: <FaPaw />, text: 'Ar condicionado' },
            { icon: <FaPaw />, text: 'Lareira' },
            { icon: <FaPaw />, text: 'Chaise lounge' },
            { icon: <FaPaw />, text: 'Bay window' },
            { icon: <FaPaw />, text: 'Frigobar' },
            { icon: <FaPaw />, text: 'Chaleira elétrica' },
            { icon: <FaPaw />, text: 'Smart TV' },
            { icon: <FaPaw />, text: 'Banheira relaxante' },
            ...
            { icon: <FaPaw />, text: 'Aquecedor de toalhas' },
            { icon: <FaPaw />, text: 'Cuba única' },
            { icon: <FaPaw />, text: 'Ampla varanda privativa' },
        ],
        images: [
...

    {
        ...
        features: [
            ...
            { icon: <FaPaw />, text: 'Aquecedor de toalhas' },
            { icon: <FaPaw />, text: 'Cuba única' },
            { icon: <FaPaw />, text: 'Varanda NÃO privativa' },
        ],
        images: [
...

    {
        ...
        features: [
            { icon: <FaPaw />, text: 'Ar condicionado' },
            { icon: <FaPaw />, text: 'Cama king size' },
            { icon: <FaPaw />, text: 'Recamier e poltrona de leitura' },
            { icon: <FaPaw />, text: 'Lareira' },
            { icon: <FaPaw />, text: 'Couch lounge' },
            { icon: <FaPaw />, text: 'Frigobar' },
            { icon: <FaPaw />, text: 'Smart TV' },
            { icon: <FaPaw />, text: 'Chaleira elétrica' },
            { icon: <FaPaw />, text: 'Banheira relaxante' },
            { icon: <FaPaw />, text: 'Chuveiro' },
            { icon: <FaPaw />, text: 'Aquecedor de toalhas' },
            { icon: <FaPaw />, text: 'Cuba para casal (dupla)' },
            { icon: <FaPaw />, text: 'Ampla varanda privativa' },
        ],
        images: [
